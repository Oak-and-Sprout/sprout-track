...
const TimelineFilter = ({
  ...
  const filterOptions = [
    ...
    { type: 'diaper', icon: <Icon iconNode={diaper} className="h-4 w-4" />, label: t('Wet Diapers') },
    { type: 'poop', icon: <Icon iconNode={diaper} className="h-4 w-4" />, label: t('Poopy Diapers') },
    { type: 'pump-stored', icon: <LampWallDown className="h-4 w-4" />, label: t('Stored Pumps') },
    { type: 'pump-consumed', icon: <LampWallDown className="h-4 w-4" />, label: t('Consumed Pumps') },
