...
export const attachmentStyles = {
  ...
  addTile: cva('flex h-[84px] w-[84px] flex-col items-center justify-center gap-1 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 text-gray-500 hover:border-teal-500 hover:text-teal-700'),
  tileLabel: cva('px-1 text-[10px] font-medium leading-tight'),
