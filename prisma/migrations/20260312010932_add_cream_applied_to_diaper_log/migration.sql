...
INSERT INTO "new_DiaperLog" ("babyId", "blowout", "caretakerId", "color", "condition", "createdAt", "deletedAt", "familyId", "id", "time", "type", "updatedAt") SELECT "babyId", "blowout", "caretakerId", "color", "condition", "createdAt", "deletedAt", "familyId", "id", "time", "type", "updatedAt" FROM "DiaperLog";
